...
{/if}
<div align="center">
<button type="button">{lng[Register]}</button> &nbsp; <a href="/login" class="main-button login-link">{lng[Login]}</a></div>
{*
...
<tr>
 <td></td>
 <td><br /><button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--colored">{lng[Register]}</button> &nbsp; <a href="/login" class="login-link">{lng[Login]}</a></td>
</tr>
</table>
*}
</form>
