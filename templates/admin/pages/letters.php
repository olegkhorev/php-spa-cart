...
foreach ($letters as $l) {
	...
	<td><label>{lng[Subject]}</label><a href="'.$current_location.'/admin/subscribtions/'.$get['2'].'/'.$l['id'].'">'.$l['subject'].'</a></td>
	<td align="center"><label>{lng[Date]}</label>'.date($datetime_format, $l['date'])."</td>
</tr>";
}
?>
