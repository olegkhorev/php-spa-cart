...
<?php */ ?>
<h1>Новости <b class="translate"><span class="hidden word">News</span><span class="hidden translate-phrase">Новости</span>(Edit)</b></h1>
...
<div class="back"><a href="/news" class="ajax_link">Вернуться к главной странице новостей <b class="translate"><span class="hidden word">Back to News mainpage</span><span class="hidden translate-phrase">Вернуться к главной странице новостей</span>(Edit)</b></a></div>
</div>
...
<br />
<a class="news-more ajax_link link-button" href="<?php echo $url;?>">Смотреть полную статью <b class="translate"><span class="hidden word">See full article</span><span class="hidden translate-phrase">Смотреть полную статью</span>(Edit)</b></a>
</div>
<div class="clear"></div>
<?php } ?>
</div>
