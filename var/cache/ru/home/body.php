...
<div class="boxes-homepage">
 <div><h2>Админ панель</h2><p>Admin: a@a.com<br />Pass: 01230<br /><a href="https://demo.spa-cart.com/admin" target="_blank">https://demo.spa-cart.com/admin</a></p></div>
 <div><h2>Ajaxfied страницы</h2><p>Все страницы clean URLs, даже админ панель</p></div>
 <div><h2>Перевод</h2><p>Легко обновить и перевести. Translate mode для быстрого и легкого перевода.</p></div>
 <div><h2>Свобода дизайна</h2><p>Это только framework. Любой дизайн может быть интегрирован</p></div>
 <div><h2>Тестирование</h2><p>Test credit card<br />4111 1111 1111 1111<br />Paypal test account<br />olegkhorev@gmail.com / 01234567</p></div>
 <div><h2>Мобильная версия</h2><p>Доступен автоматически с вашего мобильного телефона</p></div>
</div>
</div>
<div class="clear"></div>
...
<img src="/images/testimonial.jpg" class="test-image" alt="Наши Отзывы" />
<h2>Отзывы</h2>
...
<a class="all-link link-button" href="/testimonials">Все отзывы</a>
<a class="leave-link link-button" href="/testimonials/new">Написать отзыв</a>
</div>
<div class="clear"></div>
</div>
...
<div id="home-tabs">
<ul class="home-tabs">
 <li class="tab-1 active" data-tab="1">Бестселлеры</li>
</ul>
</div>
...
<div id="home-tabs">
<ul class="home-tabs">
 <li class="tab-1 active" data-tab="1">Наиболее просмотренные</li>
</ul>
</div>
...
<div id="home-tabs">
<ul class="home-tabs">
 <li class="tab-1 active" data-tab="1">Новые поступления</li>
</ul>
</div>
...
<br />
<a class="news-more ajax_link link-button" href="<?php echo $url;?>">Смотреть полную статью</a>
</div>
<div class="clear"></div>
<?php } ?>
<a href="/news" class="ajax_link link-button">Все новости</a>
<br /><br />
</div>
<?php } ?>
...
<br />
<a class="news-more ajax_link link-button" href="<?php echo $url;?>">Посмотреть весь блог</a>
</div>
<div class="clear"></div>

<a href="/blog" class="ajax_link link-button">Все блоги</a>
<br /><br />
</div>
<?php } ?>
