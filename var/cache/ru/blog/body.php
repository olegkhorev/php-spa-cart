...
<div class="actions">
<?php if ($comments) {?>
<img src="<?php echo $current_location;?>/images/comments.gif" alt="" /> <a href="<?php echo $_REQUEST_URI;?>#comments">Перейти к комментариям</a>&nbsp;
<?php } ?>
<img src="<?php echo $current_location;?>/images/leave_comment.gif" alt="" /> <a href="<?php echo $REQUEST_URI;?>#leave_comment">Оставить комментарий</a>
</div>
...
?>
<a name="comments"></a>
<h3><?php  echo $blog['comments'] ? $blog['comments'] : "0"; ?> Комментарии в блоге</h3>
...
<div class="author">
<div class="quote">
<img src="<?php echo $current_location;?>/images/quote.gif" alt="" /> <a href="javascript: void(0);" onclick="javascript: quote_comment('<?php echo $v['commentid'];?>', '<?php $name = $v['name'] ? $v['name'] : $v['firstname'].' '.$v['lastname']; $name = escape($name, 1); echo escape($name, 2);; ?>');">Цитировать</a>
</div>
Комментарий от <b><?php echo $v['name'] ? $v['name'] : $v['firstname'].' '.$v['lastname'];; ?></b>. Прокомментировал <?php echo date($datetime_format, $v['date']);; ?>.
</div>
...
<?php } else  { ?>
<br /><center>Комментариев нет</center><br /><br />
<?php } ?>
...
<br />
<center>Вы должны быть зарегистрированным пользователем, чтобы оставить комментарий.</center>
<br /><br />
<?php } else  { ?>
...
<?php if (!$login) {?>
Имя <font color='#880000'>*</font>: <input type="text" size="30" name="new_name" value="<?php echo escape($new_comment['new_name'], 2);; ?>">
<br />
<?php if ($config['General']['recaptcha_key']) {?>
<br />
...
<button type="button" onclick="javascript: new_comment();">Добавить</button>
<br /><br />
</form>
<?php 
	}
...
<div class="author">
<i><?php echo $b['firstname'];?> <?php echo $b['lastname'];?>, <?php echo $b['comments'] ? $b['comments'] : '0';; ?> Комментарии</i>
...
<div align="right">
<a class="ajax_link link-button" href="<?php echo $url;?>">Читать блог </a>&nbsp;
<a href="<?php echo $url;?>#leave_comment" class="link-button">Оставить комментарий</a>
</div>
</div>
<div class="clear"></div>
<br />
