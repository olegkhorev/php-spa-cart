...
<div class="res-zoom">
<?php /* ?>
<div data-productid="<?php echo $v['productid'];?>" class="quick-look main-button">Produktinfo</div>
<?php */ ?>
</div>
<div class="photo">
...
<?php if ($v['avail'] > 0) {?>
<button id="pid<?php echo $v['productid'];?>">Zum Warenkorb hinzufügen<span><svg><use xlink:href="/images/sprite.svg#cart"></use></svg></span></button>
<?php } else  { ?>
