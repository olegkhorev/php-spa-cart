...
<a class="header-email ajax_link" class="parent-link" href="<?php if ($config['Tickets']['use_tickets']) {?>/support_desk<?php } else  { ?>/help<?php } ?>"><svg><use xlink:href="/images/sprite.svg#email"></use></svg><?php /* ?><img src="/images/icons/email.png" alt="E-Mail uns" /><?php */ ?> E-Mail uns</a>
<div>
<a class="parent-link ajax_link" href="/page/about.html">Über CMS</a>
<ul>
...
<a class="parent-link ajax_link" href="<?php echo $current_location;?>/brands">Marken</a>
<?php if ($brands_menu) {?>
<ul>
...
<a href="<?php echo $current_location;?>/<?php if ($s2['cleanurl']) {?><?php echo $s2['cleanurl'];?><?php } else  { ?><?php echo $s2['categoryid'];?><?php } ?>"><?php echo $s2['title'];?></a>
 ...
 <?php } ?>
<?php } ?>
  <li id="menu-brands" class="<?php if ($brands_menu) {?>with-drop-down <?php } ?><?php if ($get['0'] == 'brands') {?> active<?php } ?>"><a class="parent-link" href="<?php echo $current_location;?>/brands">Marken</a>
<?php if ($brands_menu) {?>
<ul>
 <?php foreach ($brands_menu as $v) {?>
...
<div class="mrp-title">Rufen Sie Uns An</div>
