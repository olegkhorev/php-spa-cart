...
<div class="boxes-homepage">
 ...
 <div><h2>La langue des étiquettes</h2><p>Easy to Update and Translate. Translate mode for easy and quick translation.</p></div>
...
<img src="/images/testimonial.jpg" class="test-image" alt="Nos témoignages" />
<h2>Témoignages</h2>
...
<a class="all-link link-button" href="/testimonials">Tous les témoignages</a>
<a class="leave-link link-button" href="/testimonials/new">Écrire témoignage</a>
</div>
<div class="clear"></div>
</div>
...
<br />
<a class="news-more ajax_link link-button" href="<?php echo $url;?>">Voir l'article complet</a>
</div>
<div class="clear"></div>
<?php } ?>
<a href="/news" class="ajax_link link-button">Toutes les news</a>
<br /><br />
</div>
<?php } ?>
...
<br />
<a class="news-more ajax_link link-button" href="<?php echo $url;?>">Voir plein de blog</a>
</div>
<div class="clear"></div>

<a href="/blog" class="ajax_link link-button">Tous les blogs</a>
<br /><br />
</div>
<?php } ?>
