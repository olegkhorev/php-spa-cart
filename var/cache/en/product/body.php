...
product_avail[<?php echo $oid;?>] = <?php echo $product['avail'];?>;
 ...
 <td class="details">
<?php if ($oid == 1) {?> <div class="see_all"><a class="ajax_link" href="<?php echo $current_location;?>/<?php echo $product['cleanurl'] ? $product['cleanurl'].'.html' : 'product/'.$product['productid'];; ?>">See more details</a></div>
<?php } ?>
...
<?php } ?>
<tr<?php if (!$product['weight'] || $product['weight'] == '0.00') {?> class="hidden"<?php } ?>>
...
<tr class="options-error">
 <td colspan="7" align="left">Please, select all options.</td>
</tr>
...
<input type="hidden" name="options_ex" value="" />
 <button class="add2cart add2cart-product" id="productid-<?php echo $product['productid'];?>">Add to cart<span><svg><use xlink:href="/images/sprite.svg#cart"></use></svg></span></button>
 </td>
<?php } else  { ?>
 <td class="out-of-stock" colspan="3"> &nbsp; Out of stock</td>
<?php } ?>
<?php if ($oid) {?>
</tr>
<tr>
 <td colspan="4"><a class="main-button" onclick="javascript: return <?php if ($login) {?>add_wishlist(<?php echo $product['productid'];?>);<?php } else  { ?>login_popup('W');<?php } ?>" href="javascript: void(0);">Add to wishlist</a></td>
<?php } else  { ?>
...
<a href="/brands/<?php echo $product['brand']['cleanurl'];?>" class="ajax_link">
<?php 
...
<?php } ?>
<a href="/brands/<?php echo $product['brand']['cleanurl'];?>" class="ajax_link"><?php echo $product['brand']['name'];?></a>
</div>
<?php } ?>
...
<br /><br />
<a href="/ticket?productid=<?php echo $product['productid'];?>" class="ajax_link link-button">Ask a question about this product</a>
<br /><br /><br />
