...
&nbsp;
<input size="40" id="helptext" type="hidden" readonly>
<br />
...
<a href="<?php echo $url;?>" class="simple-button"><?php  echo $b['title']; ?></a>
</div>
<div class="image">
<?php if ($b['imageid']) {?>
<a href="<?php echo $url;?>">
<?php 
		$image = $b;
		$image['new_width'] = 750;/*$config['Blog']['blogs_image_x'];*/
		$image['new_height'] = 400;
		include SITE_ROOT . '/includes/blog_image.php';
?>
</a>
...
<?php echo $b['descr'];?>
<div align="right">
<img src="<?php echo $current_location;?>/images/read_more.gif" alt="Read blog" /> <a href="<?php echo $url;?>">Read blog</a>&nbsp;
<img src="<?php echo $current_location;?>/images/leave_comment.gif" alt="Leave a comment" /> <a href="<?php echo $url;?>#leave_comment">Leave a comment</a>
</div>
</div>
<?php } ?>
</div>
