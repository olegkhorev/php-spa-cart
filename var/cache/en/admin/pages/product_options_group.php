...
if ($options) {	foreach ($options as $k=>$v) {		echo '<tr>
 ...
 <td><label>Name</label><input type="text" class="width-95p" name="options_data['.$v['optionid'].'][name]" value="'.escape($v['name']).'" /></td>
 <td><label>Price</label><input size="5" type="text" name="options_data['.$v['optionid'].'][price_modifier]" value="'.escape($v['price_modifier']).'" /></td>
 ...
 <td><label>Weight</label><input size="5" type="text" name="options_data['.$v['optionid'].'][weight_modifier]" value="'.escape($v['weight_modifier']).'" /></td>
 <td class="no-word-break"><label>&nbsp;</label>
 ...
 <td><label>Pos</label><input size="5" type="text" name="options_data['.$v['optionid'].'][orderby]" value="'.$v['orderby'].'" /></td>
 <td align="center"><label>Enabled</label><input type="checkbox" name="options_data['.$v['optionid'].'][enabled]" value="1" '.($v['enabled'] ? ' checked' : '').'></td>
</tr>';
	}
}
?>
<tr id="add_new">
 <td><label>Add</label><a href="javascript: void(0);" onclick="duplicate_row($('#add_new'), $(this));" class="duplicate_plus">+</a></td>
 <td><label>Name</label><input type="text" class="width-95p" name="new_option[0][name]" /></td>
 <td><label>Price</label><input size="5" type="text" name="new_option[0][price_modifier]" /></td>
 <td class="no-word-break"><label>&nbsp;</label>
 ...
 <td><label>Weight</label><input size="5" type="text" name="new_option[0][weight_modifier]" /></td>
 <td class="no-word-break"><label>&nbsp;</label>
 ...
 <td><label>Pos</label><input size="5" type="text" name="new_option[0][orderby]" /></td>
 <td align="center"><label>Enabled</label><input type="checkbox" name="new_option[0][enabled]" checked value="1" /></td>
</tr>
</table>
<br />
<?php 
