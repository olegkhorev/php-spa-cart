...
<?php if ($config['Visual']['visual_boxes_below_banner'] == 'Y') {?>
...
<div class="boxes-homepage">
 ...
 <div><h2>Language labels</h2><p>Easy to Update and Translate. Translate mode for easy and quick translation.</p></div>
...
<?php if ($config['Visual']['visual_bestsellers'] == 'Y' && $bestsellers) {?>
<?php /* ?> End page container <?php */ ?>
</div>
</div>
<div class="clear"></div>
...
<div id="home-tabs">
<ul class="home-tabs">
 <li class="tab-1 active" data-tab="1">Bestsellers</li>
</ul>
</div>
...
<?php if ($config['Visual']['visual_most_viewed'] == 'Y' && $most_viewed) {?>
<?php /* ?> End page container <?php */ ?>
</div>
</div>
<div class="clear"></div>
...
<div id="home-tabs">
<ul class="home-tabs">
 <li class="tab-1 active" data-tab="1">Most viewed</li>
</ul>
</div>
...
<?php if ($config['Visual']['visual_new_arrivals'] == 'Y' && $new_arrivals) {?>
<?php /* ?> End page container <?php */ ?>
</div>
</div>
<div class="clear"></div>
...
<div id="home-tabs">
<ul class="home-tabs">
 <li class="tab-1 active" data-tab="1">New arrivals</li>
</ul>
</div>
...
<?php if ($config['Visual']['visual_news'] == 'Y' && $last_news) {?>
<?php /* ?> Page container assign <?php */ ?>
</div>
</div>
<div class="clear"></div>
...
<div class="clear"></div>
<?php } ?>
<a href="/news" class="ajax_link link-button">All news</a>
<br /><br />
</div>
<?php } ?>

<?php if ($config['Visual']['visual_blogs'] == 'Y' && $last_blog) {?>
<?php /* ?> Page container assign <?php */ ?>
</div>
</div>
<div class="clear"></div>
...
<br />
<a class="news-more ajax_link link-button" href="<?php echo $url;?>">See full blog</a>
</div>
<div class="clear"></div>

<a href="/blog" class="ajax_link link-button">All blogs</a>
<br /><br />
</div>
<?php } ?>
