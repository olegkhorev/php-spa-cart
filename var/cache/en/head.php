...
<?php if ($login) {?>
<a href="/profile" onclick="javascript: return profile_popup(1);">Account</a>
...
<a href="/register" onclick="javascript: return register_popup();">Register</a>
<a href="/login" onclick="javascript: return login_popup();">Wishlist</a>
<a href="/login" onclick="javascript: return login_popup();">Gift Cards</a>
<?php } ?>
<a class="parent-link ajax_link" href="<?php echo $current_location;?>/blog">Blog</a>
<a class="parent-link ajax_link" href="/news">News</a>
<a class="header-email ajax_link" class="parent-link" href="<?php if ($config['Tickets']['use_tickets']) {?>/support_desk<?php } else  { ?>/help<?php } ?>"><svg><use xlink:href="/images/sprite.svg#email"></use></svg><?php /* ?><img src="/images/icons/email.png" alt="Email us" /><?php */ ?> Email us</a>
<div>
<a class="parent-link ajax_link" href="/page/about.html">About CMS</a>
<ul>
...
<a class="parent-link ajax_link" href="<?php echo $current_location;?>/brands">Brands</a>
<?php if ($brands_menu) {?>
<ul>
...
<a href="<?php echo $current_location;?>/<?php if ($s2['cleanurl']) {?><?php echo $s2['cleanurl'];?><?php } else  { ?><?php echo $s2['categoryid'];?><?php } ?>"><?php echo $s2['title'];?></a>
 ...
 <?php } ?>
<?php } ?>
  <li id="menu-brands" class="<?php if ($brands_menu) {?>with-drop-down <?php } ?><?php if ($get['0'] == 'brands') {?> active<?php } ?>"><a class="parent-link" href="<?php echo $current_location;?>/brands">Brands</a>
<?php if ($brands_menu) {?>
<ul>
 <?php foreach ($brands_menu as $v) {?>
...
<div class="instant-search"><div class='enter-3-chars'>Enter at least 2 characters</div></div>
</div>
</form>
  </li>
</ul>
...
<span>For all orders created in below 30 days</span>
 </td>
 <td>
<div class="sh-rounded-box">
...
<span>Any time any place: <?php echo $config['Company']['company_phone'];?></span>
 </td>
</tr>
</table>
</div>
