...
if ($config['Visual']['visual_bestsellers'] == 'Y') {
...
if ($config['Visual']['visual_most_viewed'] == 'Y') {
...
if ($config['Visual']['visual_new_arrivals'] == 'Y') {
...
if ($config['Visual']['visual_news'] == 'Y') {
...
if ($config['Visual']['visual_blogs'] == 'Y') {
