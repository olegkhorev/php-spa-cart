...
if (!file_exists($new_file)) {
	$file = SITE_ROOT . '/photos/blog/'.$image['blogid'].'/'.$image['imageid'].'/'.$image['file'];
...
if ($image['only_url'] == 'Y') {
	...
	$image['url'] = $current_location.'/photos/blog/'.$image['blogid'].'/'.$image['imageid'].'/'.$image['file'];
	if ($image['link']) {
