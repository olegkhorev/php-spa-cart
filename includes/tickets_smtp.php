 ...
 * mime_parser.php
 *
 * @(#) $Id: mime_parser.php,v 1.57 2008/06/14 18:52:39 mlemos Exp $
 *
 */
...
<class>
        ...
        <version>@(#) $Id: mime_parser.php,v 1.57 2008/06/14 18:52:39 mlemos Exp $</version>
...
*/
        Function Analyze($message, &$results)
        {
                ...
                if (!$message['Headers']['content-type:'])
                        $message['Headers']['content-type:'] = array();
 ...
 * pop3.php
 *
 * @(#) $Header: /home/mlemos/cvsroot/pop3/pop3.php,v 1.21 2008/01/09 07:28:29 mlemos Exp $
 *
 */
...
#                fputs($fp, "GET $url HTTP/1.0 Host: $proxy ");
#                return(fputs($this->connection,"GET $line HTTP/1.0\r\nHost: ".$this->hostname."\r\n"));
